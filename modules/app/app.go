...
// 	basemodule "github.com/shihray/gserver/modules/module"
...
// 		RegisterInterval: time.Millisecond * time.Duration(6000), // 多久時間註冊一次
// 		RegisterTTL:      time.Millisecond * time.Duration(6100),
// 		KillWaitTTL:      time.Millisecond * time.Duration(10000),
// 		Debug:            true,
// 	}
